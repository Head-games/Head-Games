...
contract HeadFootBall is Context, IERC20, Ownable {
    ...
    uint256 constant _tTotal = 1 * 10**9 * 10**9; //1 Billion Supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string constant _name = "HeadFootBall";
    string constant _symbol = "$HEAD";
    ...
    address payable public _marketingWallet = payable(address(0xfD34A7043f60d81Fc69CE08C219c76fc1479D4E3)); //Replace your Marketing Wallet Address Here
   ...
   function balanceOf(address account) public view override returns (uint256) {
    ...
    require(newAddress != address(uniswapV2Router), "TOKEN: The router already has that
            address");
    ...
    function setMaxTxAmount(uint256 value) external onlyOwner() {
        require (value >= 5000000, "Max Tx limit should be greator than equal to 0.5% of the supply")
